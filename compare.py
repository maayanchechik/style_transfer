...
model_path = "/home/mc/StyleTransfer/model_a001_b0.005_lr0.001.model"
...
fast_out_img = utils.postp(output_of_saved_model.data[0].cpu().squeeze())
...
normal_out_img = utils.postp(stylized_image.data[0].cpu().squeeze())
